...
<!--
    ...
    <div class="content moretext bodyMiddleOnly">
    		<img src="img/note_page_development.png" />
    		
        <div class="maintext">
		<h3></h3>
		 <ul class="evenOddItalic">
		    <li></li>
	     </ul>
    -->


            <!-- Taken from Achim Juhl's draft. --> 
			<div id="post-1" class="hentry p1 post publish author-admin category-allgemein untagged y2008 m02 d01 h11">
